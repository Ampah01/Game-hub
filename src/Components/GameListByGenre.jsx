function GameListByGenre({ gameGenre, selectedGenre }) {
  return (
    <div className="flex flex-col items-center md:items-start z-10 md:ml-20 lg:ml-0">
      <h3 className="text-zinc-800 text-2xl font-bold dark:text-slate-50 mb-4 items-start justify-start">
        {selectedGenre} Games
      </h3>
        ...
        {gameGenre.map((game, index) => (
          ...
          >
            <img
              ...
              alt={game.name}
            />
            <p className="text-lg font-semibold mb-1 items-start ">
              {game.name}
